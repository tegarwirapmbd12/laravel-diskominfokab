...
@section('content')
            ...
            <div class="row">
               ...
               <div class="col-lg-6 col-md-6 col-12">
                  <div class="about-wel-img-sec img-overlay">
                     ...
                     <div class="img-wrap">
                        <img class="img-fluid" src="{{ asset('nekaton/assets/img/bg/home-about-img.jpg') }}" alt="">
                     </div>
                  </div>
               </div>
               <!-- end col -->
      ...
      <section id="counter" class="counter-padding overlay section-back-image" data-background="{{ asset('nekaton/assets/img/bg/counter-bg.jpg') }}">
         <div class="auto-container">
            <div class="row">
                  ...
                  <div class="team-slides owl-carousel owl-theme">
                     <div class="single-team-wrapper">
                        <div class="single-team-member">
                           <img class="img-fluid" src="{{ asset('nekaton/assets/img/team/1.jpg') }}" alt="">
                     ...
                     <div class="single-team-wrapper">
                        <div class="single-team-member">
                           <img class="img-fluid" src="{{ asset('nekaton/assets/img/team/2.jpg') }}" alt="">
                           <div class="single-team-member-content">
                              <ul class="single-team-member-social">
                                 <li><a href="#"><i class="icofont-facebook"></i></a></li>
                                 <li><a href="#"><i class="icofont-twitter"></i></a></li>
                     ...
                     <div class="single-team-wrapper">
                        <div class="single-team-member">
                           <img class="img-fluid" src="{{ asset('nekaton/assets/img/team/3.jpg') }}" alt="">
                           <div class="single-team-member-content">
                              <ul class="single-team-member-social">
                                 <li><a href="#"><i class="icofont-facebook"></i></a></li>
                                 <li><a href="#"><i class="icofont-twitter"></i></a></li>
                     ...
                     <div class="single-team-wrapper">
                        <div class="single-team-member">
                           <img class="img-fluid" src="{{ asset('nekaton/assets/img/team/4.jpg') }}" alt="">
                           <div class="single-team-member-content">
                              <ul class="single-team-member-social">
                                 <li><a href="#"><i class="icofont-facebook"></i></a></li>
                                 <li><a href="#"><i class="icofont-twitter"></i></a></li>
                     ...
                     <div class="single-team-wrapper">
                        <div class="single-team-member">
                           <img class="img-fluid" src="{{ asset('nekaton/assets/img/team/5.jpg') }}" alt="">
                           <div class="single-team-member-content">
                              <ul class="single-team-member-social">
                                 <li><a href="#"><i class="icofont-facebook"></i></a></li>
                                 <li><a href="#"><i class="icofont-twitter"></i></a></li>
      ...
      <section id="testimonial" class="section-padding overlay section-back-image" data-background="{{ asset('nekaton/assets/img/bg/faq-bg.jpg') }}">
         <div class="auto-container">
            <div class="row ml-lg-4 ml-md-4 ml-0 mr-lg-4 mr-md-4 mr-0">
               <div class="col-lg-6 col-md-12 col-12 mb-lg-0 mb-md-5 mb-5">
                  ...
                  <div class="owl-carousel owl-theme testimonial-wrapper">
                     <div class="item" data-dot="<img class='testimonial-thumb rounded' src='{{ asset('nekaton/assets/img/testimonial/1.png') }}'/>">
                     ...
                     <!-- end single item -->
                     <div class="item" data-dot="<img class='testimonial-thumb rounded' src='{{ asset('nekaton/assets/img/testimonial/2.png') }}'/>">
                        <div class="testimonial-inner">
                           <div class="tes-quote">
                              <i class="icofont-quote-left"></i>
                           </div>
                     ...
                     <!-- end single item -->
                     <div class="item" data-dot="<img class='testimonial-thumb rounded' src='{{ asset('nekaton/assets/img/testimonial/3.png') }}'/>">
                        <div class="testimonial-inner">
                           <div class="tes-quote">
                              <i class="icofont-quote-left"></i>
                           </div>
            ...
            <div class="row project-list">
               <div class="col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-4 mb-4 two">
                  <figure class="portfolio-sin-item">
                     <img class="img-fluid" src="{{ asset('nekaton/assets/img/gallery/5.jpg') }}" alt="" />
                     <figcaption>
                        <h3>Portfolio Title</h3>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox" href="{{ asset('nekaton/assets/img/gallery/5.jpg') }}" data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
               ...
               <div class="col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-4 mb-4 four">
                  <figure class="portfolio-sin-item">
                     <img class="img-fluid" src="{{ asset('nekaton/assets/img/gallery/2.jpg') }}" alt="" />
                     <figcaption>
                        <h3>Portfolio Title</h3>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox" href="{{ asset('nekaton/assets/img/gallery/2.jpg') }}" data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                           <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                        </div>
                     </figcaption>
                  </figure>
               ...
               <div class="col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-4 mb-4 two four">
                  <figure class="portfolio-sin-item">
                     <img class="img-fluid" src="{{ asset('nekaton/assets/img/gallery/6.jpg') }}" alt="" />
                     <figcaption>
                        <h3>Portfolio Title</h3>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox" href="{{ asset('nekaton/assets/img/gallery/6.jpg') }}" data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                           <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                        </div>
                     </figcaption>
                  </figure>
               ...
               <div class="col-lg-4 col-md-6 col-12 two mb-md-4 mb-4 one three">
                  <figure class="portfolio-sin-item">
                     <img class="img-fluid" src="{{ asset('nekaton/assets/img/gallery/1.jpg') }}" alt="" />
                     <figcaption>
                        <h3>Portfolio Title</h3>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox" href="{{ asset('nekaton/assets/img/gallery/1.jpg') }}" data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                           <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                        </div>
                     </figcaption>
                  </figure>
               ...
               <div class="col-lg-4 col-md-6 col-12 mb-4 two one">
                  <figure class="portfolio-sin-item">
                     <img class="img-fluid" src="{{ asset('nekaton/assets/img/gallery/4.jpg') }}" alt="" />
                     <figcaption>
                        <h3>Portfolio Title</h3>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox" href="{{ asset('nekaton/assets/img/gallery/4.jpg') }}" data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                           <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                        </div>
                     </figcaption>
                  </figure>
               ...
               <div class="col-lg-4 col-md-6 col-12 one three four">
                  <figure class="portfolio-sin-item">
                     <img class="img-fluid" src="{{ asset('nekaton/assets/img/gallery/3.jpg') }}" alt="" />
                     <figcaption>
                        <h3>Portfolio Title</h3>
                        <div class="port-icon mt-3">
                           <a class="icon-ho venobox" href="{{ asset('nekaton/assets/img/gallery/3.jpg') }}" data-title="PORTFOLIO TITTLE" data-gall="gall1"><i class="icofont-eye"></i></a>
                           <a class="icon-ho" href="#"><i class="icofont-link"></i></a>
                        </div>
                     </figcaption>
                  </figure>
            ...
            <div class="row mb-5">
               <div class="col">
                  <div class="blog-slides owl-carousel owl-theme">
                     <div class="blog-home-single">
                        ...
                        <div class="blog-home-des-wrap">
                           ...
                           <div class="blog-home-des-right">
                              <div class="havator">
                                 <img class="img-fluid" src="{{ asset('nekaton/assets/img/testimonial/1.png') }}" alt=""/>
                              </div>
                     ...
                     <div class="blog-home-single">
                        <div class="blog-home-image">
                           <img class="img-fluid" src="{{ asset('nekaton/assets/img/blog/2.jpg') }}" alt=""/>
                           <div class="blog-home-post-date">
                              <i class="icofont-clock-time"></i>
                        ...
                        <div class="blog-home-des-wrap">
                           ...
                           <div class="blog-home-des-right">
                              <div class="havator">
                                 <img class="img-fluid" src="{{ asset('nekaton/assets/img/testimonial/2.png') }}" alt=""/>
                              </div>
                              <div class="blog-home-meta">
                                 <span>Post By<a href="#">Nekaton</a></span>
                                 <span>School,Learn</span>
                     ...
                     <div class="blog-home-single">
                        <div class="blog-home-image">
                           <img class="img-fluid" src="{{ asset('nekaton/assets/img/blog/4.jpg') }}" alt=""/>
                           <div class="blog-home-post-date">
                              <i class="icofont-clock-time"></i>
                        ...
                        <div class="blog-home-des-wrap">
                           ...
                           <div class="blog-home-des-right">
                              <div class="havator">
                                 <img class="img-fluid" src="{{ asset('nekaton/assets/img/testimonial/3.png') }}" alt=""/>
                              </div>
                              <div class="blog-home-meta">
                                 <span>Post By<a href="#">Nekaton</a></span>
                                 <span>School,Learn</span>
                     ...
                     <div class="blog-home-single">
                        <div class="blog-home-image">
                           <img class="img-fluid" src="{{ asset('nekaton/assets/img/blog/3.jpg') }}" alt=""/>
                           <div class="blog-home-post-date">
                              <i class="icofont-clock-time"></i>
