<section class="slider-section">
    <div class="home-slides owl-carousel owl-theme">
       <div class="home-single-slide" data-background="{{ asset('nekaton/assets/img/bg/slide1.jpg') }}">
       ...
       <!-- end single slider -->
       <div class="home-single-slide" data-background="{{ asset('nekaton/assets/img/bg/slide2.jpg') }}">
          <div class="home-single-slide-overlay"></div>
          <div class="home-single-slide-inner">
             <div class="container">
                <div class="row">
       ...
       <!-- end single slider -->
       <div class="home-single-slide" data-background="{{ asset('nekaton/assets/img/bg/slide3.jpg') }}">
          <div class="home-single-slide-overlay"></div>
          <div class="home-single-slide-inner">
             <div class="container">
                <div class="row">
